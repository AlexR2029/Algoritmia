...
================================
Gestiona la interfaz gráfica del juego: mensajes, botones, indicadores.

Funcionalidades:
- Mostrar panel superior con información (minas, banderas, tiempo)
...
class InterfazUsuario:
    """
    Clase que gestiona todos los elementos de interfaz del juego.
    
    Incluye:
    - Panel superior con información
    - Botón de reinicio
    - Mensajes de estado
    - Contador de banderas y tiempo
    """
    ...
    def __init__(self, ancho_pantalla, alto_panel_superior=120):
        ...
        Args:
            ancho_pantalla (int): ancho total de la ventana
            alto_panel_superior (int): altura del panel superior en píxeles
        """
        self.ancho_pantalla = ancho_pantalla
        self.alto_panel = alto_panel_superior
        
        # Colores
        self.COLOR_FONDO_PANEL = (60, 60, 60)        # Gris oscuro
        self.COLOR_TEXTO = (255, 255, 255)           # Blanco
        self.COLOR_BOTON = (100, 200, 100)           # Verde
        self.COLOR_BOTON_HOVER = (120, 220, 120)     # Verde claro
        self.COLOR_VICTORIA = (50, 200, 50)          # Verde brillante
        self.COLOR_DERROTA = (200, 50, 50)           # Rojo
    ...
    def pausar_cronometro(self):
        """
        Pausa el cronómetro cuando el juego termina.
        """
    ...
    def obtener_tiempo_transcurrido(self):
        ...
        Returns:
            int: segundos desde el inicio del juego
        """
    ...
    def dibujar_panel_superior(self, pantalla, numero_minas, banderas_colocadas, 
        ...
        Args:
            ...
            numero_minas (int): total de minas en el tablero
            banderas_colocadas (int): banderas que ha colocado el jugador
            juego_terminado (bool): si el juego ha terminado
            victoria (bool): si el jugador ganó
        """
        # Fondo del panel
        ...
        # Información de minas restantes (izquierda)
    ...
    def _dibujar_boton_reinicio(self, pantalla):
        ...
        Args:
            pantalla: superficie de pygame donde dibujar
        """
        # Determinar color según si el mouse está sobre el botón
    ...
    def _dibujar_mensaje_victoria(self, pantalla, tiempo):
        ...
        Args:
            pantalla: superficie de pygame donde dibujar
            tiempo (int): tiempo que tardó en ganar
        """
    ...
    def _dibujar_mensaje_derrota(self, pantalla):
        """
        Dibuja mensaje de derrota en el centro de la pantalla.
    ...
    def boton_reinicio_clickeado(self, x, y):
        """
        Verifica si se hizo click en el botón de reinicio.
        ...
        Returns:
            bool: True si se clickeó el botón de reinicio
        """
        return self.boton_rect.collidepoint(x, y)
    
    def obtener_altura_panel(self):
        """
        Obtiene la altura del panel superior.
        
        Returns:
            int: altura en píxeles del panel superior
        """
